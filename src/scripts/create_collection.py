...
SUMMARY_PROMPT = (
    ...
    "3. Try to cover all the information in the document.\n"
    ...
    "### [3] FORMATTING\n"
    " - Structure your response as a list but you must NOT include any punctuation at the start (no dashes nor numbers). Just provide the summary as is.\n"
